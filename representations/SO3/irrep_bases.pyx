...
This file contains routines that produce change-of-basis matrices or functions
...
as described in spherical_harmonics.py and in [1]. However, these differ by either
...
#TODO: make this function conform to the gufunc convention
